        ...
        {toggleSkills ? (
          <div className="flex justify-center xl:px-38 md:px-10 px-1  ">
            <div className="grid md:grid-rows-2 grid-rows-3 md:grid-cols-3 grid-cols-2 gap-4 p-4">
              <div
                className="relative sm:flex flex-shrink-0 md:block flex-row items-center rounded-xl md:rounded-2xl p-4 md:p-6 space-x-0 sm:space-x-6 md:space-x-0 
              ...
              >
                ...
                />
                <div className="md:absolute bottom-6 left-6 mt-6 md:mt-0">
                  <h1 className="text-md font-sans font-normal lg:mt-4">
                    <div>Frontend</div>
                    <div>Development &nbsp;&nbsp;&nbsp;&nbsp;</div>
                  </h1>
                  <p className="text-[10px] mt-1 font-raleway text-gray-300 lg:block hidden ">
              ...
              >
                ...
                <div className="md:absolute bottom-6 left-6 mt-6 md:mt-0">
                  ...
                  <p className="text-[10px] mt-1 font-raleway text-gray-300 lg:block hidden ">
                    Building powerful architecture and scalable logic from
                    scratch.
                  </p>
                </div>
              </div>
            ...
            <div className="grid md:grid-rows-2 grid-rows-3 md:grid-cols-3 grid-cols-2 gap-4 p-4">
              ...
              >
                ...
                <div className="md:absolute bottom-6 left-6 mt-6 md:mt-0">
                  ...
                  <p className="text-[10px] mt-1 font-raleway text-gray-300 lg:block hidden">
                    Working effectively & productively in team environment.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="md:absolute bottom-6 left-6 mt-6 md:mt-0">
                  ...
                  <p className="text-[10px] mt-1 font-raleway text-gray-300 lg:block hidden">
                    Efficiently organizing and prioritizing one task over another.
                  </p>
                </div>
              </div>
              <div
              ...
              >
                ...
                <div className="md:absolute bottom-6 left-6 mt-6 md:mt-0">
                  ...
                  <p className="text-[10px] mt-1 font-raleway text-gray-300 lg:block hidden">
                    observing everyone&#39;s thinking and realizing what no one
                    has thought
                  </p>
                </div>
              </div>
